...
insert into jogos (Nome_Jogo,Descricao_Jogo,Genero_Jogo,Produtora_Jogo) values ('Homem Aranha','Versão TEEN','Acao','Top Games Kids');
...
insert into Aluguel (Funcionario_idFuncionario,VideoGame_idVideoGame,Cliente_idCliente,Jogos_idJogos,ValorAluguel,Data_Aluguel) values (3,6,1,3,17.86,20/01/2004);
insert into Aluguel (Funcionario_idFuncionario,VideoGame_idVideoGame,Cliente_idCliente,Jogos_idJogos,ValorAluguel,Data_Aluguel) values (3,6,1,3,17.86,09/01/2013);
insert into Aluguel (Funcionario_idFuncionario,VideoGame_idVideoGame,Cliente_idCliente,Jogos_idJogos,ValorAluguel,Data_Aluguel) values (3,6,1,3,17.86,04/01/2013);
insert into Aluguel (Funcionario_idFuncionario,VideoGame_idVideoGame,Cliente_idCliente,Jogos_idJogos,ValorAluguel,Data_Aluguel) values (1,1,2,1,19.5,03/03/2013);